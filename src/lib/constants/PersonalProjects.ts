const PersonalProjects = [
  ...
  // },
  {
    ...
    description: "A simple interface for browsing the EVE Online market and tracking prices of items",
    highlights: [
      "Fully vibe-coded; an experiment in using AI code generation to ship a functional web application with minimal manual authorship",
      "Designed a dual-panel hierarchical drill-down UI for navigating the EVE Online market category tree of 1,500+ market groups and 18,000+ item types",
      "Integrated EVE's public API for live market prices, with localStorage caching and ETag-based stale-while-revalidate to honor the 1-hour cache window",
      "Converts CCP's game data YAML exports into pre-computed JSON indexes for market group hierarchies, icon mappings, and item type lookups enabling O(1) client lookups without bloating the JS bundle; no database required",
      "ROADMAP: search bar, get and cache item images via API, add a way to price items by station and identify profitable arbitrage opportunities",
    ],
  },
  {
